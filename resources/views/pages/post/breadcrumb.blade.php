<div class="rn-page-title-area pt--120 pb--190 bg_image bg_image--7" data-black-overlay="6" style="background-image: url({{ img('unsplash::lBIFDzYwbDo')->url() }});">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="blog-single-page-title text-center pt--100">
                    ...
                    <h2 class="title theme-gradient">{{ $entry->title }}</h2>
                        {{-- <ul class="blog-meta d-flex justify-content-center align-items-center">
                            <li><i data-feather="clock"></i>{{ $entry->created_at }}</li>
