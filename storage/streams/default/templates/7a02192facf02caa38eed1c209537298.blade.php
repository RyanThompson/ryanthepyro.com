...
Laravel comes with a basic Vite configuration. In my case, I just popped open the `resources/css/app.css` and dumped in my unminified CSS contents to sort out later in organization and optimization.
